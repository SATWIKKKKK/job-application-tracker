...
export default async function PortalsPage() {
  ...
  return (
    <DashboardShell user={user}>
      <div className="mb-8">
        <h1 className="font-headline text-4xl font-extrabold">Portals</h1>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3 xl:grid-cols-4">
        {SUPPORTED_PORTALS.map((portal, index) => {
          ...
          return (
            <div key={portal} className="relative rounded-xl border border-outline-variant bg-white p-6">
              <div className="font-headline text-xl font-bold">{portal}</div>
              ...
              {locked ? (
                <div className="absolute inset-0 flex flex-col items-center justify-center rounded-xl bg-white/85 text-center">
